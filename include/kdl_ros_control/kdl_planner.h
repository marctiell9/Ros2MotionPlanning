...
public:
    ...
    trajectory_point compute_trajectory(double time,int choice);
    ...
    KDLPlanner(double _trajDuration,double _trajRadius,double _accDuration, Eigen::Vector3d _trajInit, Eigen::Vector3d _trajEnd);
